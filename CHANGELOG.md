...
* remove unnecessary files from rpi clear boot partition [Yann CARDAILLAC]

# v0.0.7
## (2026-07-31)

* classes/sb-override: Add :sb override, drop redundant size globals [guille-vega]

# v0.0.6
## (2026-06-02)

* the eeprom binary was renamed so that we can use self update in non secureboot as well [Yann CARDAILLAC]

# v0.0.5
## (2026-04-08)

* Remove discontinued device types raspberrypi400-64, revpi-connect, revpi-core-3 [Florin Sarbu]

# v0.0.4
## (2025-12-11)

* bootfiles: do not append OS command line [Alex Gonzalez]
